...
const Footer = () => {
  return (
    <footer className="border-t-2 border-t-blue-100 bg-blue-50 py-8">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            <h2 className="text-xl font-bold text-blue-700">FutureScope</h2>
            <p className="text-sm text-gray-600">© 2026 FutureScope. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="hover:text-blue-600 text-gray-600 transition-colors" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="hover:text-blue-600 text-gray-600 transition-colors" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="hover:text-blue-600 text-gray-600 transition-colors" aria-label="LinkedIn">
